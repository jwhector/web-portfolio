...
export default function Contact() {
    ...
    const handleScroll = () => {
        const labelElem = document.querySelector('#contact-label');
        const labelRect = labelElem.getBoundingClientRect();
        const portfolioLabelElem = document.querySelector('#portfolio-label');
        ...
        if (labelRect.y <= labelRect.height) {
            portfolioLabelElem.classList.add('pin-bottom-left');
        } else {
            portfolioLabelElem.classList.remove('pin-bottom-left');
        }

        const prevElem = document.querySelector('#portfolio');
